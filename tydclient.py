...
class TydMainFrame(wx.Frame):
  def __init__(self, parent, id, title):
    ...
    self.btnHelp = buttons.GenBitmapTextButton(pRight,-1, label=u"系统报修", 
        bitmap=wx.ArtProvider.GetBitmap(wx.ART_MISSING_IMAGE), size=(160, 45))
    self.btnHelp.Bind(wx.EVT_BUTTON, self.OnHelp)
    gs.Add(self.btnHelp, 0, wx.ALIGN_CENTER | wx.ALL, 15) 


    self.btnPhones = buttons.GenBitmapTextButton(pRight,-1, label=u" 分机列表", 
